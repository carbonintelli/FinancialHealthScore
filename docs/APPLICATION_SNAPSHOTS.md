...
Related: [APPLICATION_UI_SNAPSHOTS.md](./APPLICATION_UI_SNAPSHOTS.md) (visual screenshots) · [APPLICATION_UI_SNAPSHOTS.html](./APPLICATION_UI_SNAPSHOTS.html) (self-contained gallery) · [PRODUCT_SNAPSHOTS.md](./PRODUCT_SNAPSHOTS.md) (API golden files) · [PLATFORM.md](./PLATFORM.md) · [TERMINOLOGY.md](./TERMINOLOGY.md)
